 ...
 */
public class AnimationListViewNew extends FrameLayout{
    ...
    public AnimationListViewNew(Context context) {
        super(context);
        init();
    }

    public AnimationListViewNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AnimationListViewNew(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AnimationListViewNew(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void createAnimationView(){
        ...
        mAnimationView.setOnAnimationViewListener(new OnAnimationViewListener() {
            ...
            public void pageNext() {
                AnimationListViewNew.this.pageNext();
            }

            @Override
            public void pagePrevious() {
                AnimationListViewNew.this.pagePrevious();
            }
        });
    }

    private void initAniamtionView(Bitmap frontBitmap, Bitmap backBitmap){
        if(mAnimationView instanceof BlindsView) {
            ((BlindsView) mAnimationView).init(mRowCount, mColumnCount, frontBitmap, backBitmap);
        }
    }
}
